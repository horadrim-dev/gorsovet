# Generated by Django 4.2.9 on 2025-05-07 04:55
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(help_text='Пример: Созыв 3 (04.2003 - 10.2008)', verbose_name='Название')),
            ],
        ),
        migrations.CreateModel(
            name='Deputat',
            fields=[
                ...
                ('sozyv', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='deputaty.sozyv', verbose_name='Созыв')),
            ],
            options={
                'verbose_name': 'депутат',
                'verbose_name_plural': 'депутаты',
                'ordering': ['sozyv', 'order'],
            },
        ),
    ]
